...
% maize2018 is A0 (33"x46")
%\documentclass[a0,portrait]{a0poster}

\documentclass[a0,25pt]{sciposter}
...
\usepackage[font=normalsize,labelfont={bf,color=CarnegiePriBlue},textfont={color=CarnegiePriBlue},margin=0pt,skip=18pt]{caption}
...
%% width of figures for consistency; set for a0 three-column
\newlength{\figwidth}
\setlength{\figwidth}{233mm}
...
% \usepackage[texcoord=true,grid,gridcolor=red!20,subgridcolor=green!20,gridunit=mm]{eso-pic}
...
\end{minipage}
\hfill
\begin{minipage}[m]{0.47\linewidth}                      % Carnegie DPB logo
  \hfill
